---
title: Saifeddine Rajhi's Software Engineer CV
description: Saifeddine Rajhi's Software Engineer CV
...
<div class="cv-content-column main-column">
    <ExperienceSection topMargin={false} jobs={[
        ...
        },
        {
            ...
            highlights: [
                "<a target='_blank' rel='noopener' href='/cv/machine-learning-engineer/' title='Go to ML Engineer's Resume'>The rest of the ML engineering experience could be found there.</a>",
            ],
            skills: [
                "data analysis",
                "tabular data",
