...
const BlogComments = loadable(() => 
  import("../components/blog/comments")
)


const GhBlogComments = loadable(() => 
  import("../components/blog/gh-comments")
)
    ...
    <Layout>
      ...
      <main>
        ...
        <ShareBlock title={title} path={path} tags={keywords} className="spaced-component" />
         <br></br>
        <GhBlogComments className="spaced-component" />
        <br></br>
        <NewsletterForm className="spaced-component" />
        <br></br>
