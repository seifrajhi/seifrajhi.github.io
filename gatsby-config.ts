...
const config: GatsbyConfig = {
  siteMetadata: {
    ...
    description: `Hey 👋 My name is Saifeddine and I'm a Senior Platform Engineer Engineer, Cloud and DevOps enthusiastic and Life Explorer 🧔🛠👨‍💻📚`,
    keywords: [
      "Saifeddine Rajhi",
      "Saif Rajhi",
      "Saifeddine Rajhi",
    ...
    personRichSnippet: {
      ...
      gender: `Male`,
      jobTitle: `Senior Platform  Engineer, Open source contributor`,
      worksFor: {
        name: "NA",
        sameAs: "later",
      },
      sameAs: [
        `https://twitter.com/RajhiSaifeddine`,
